...
def fking1(ids,passlist):
        ...
        try:
                for pas in passlist:
                        ...
                        ua = 'Dalvik/2.1.0 (Linux; U; Android 12.0.0; 22041219C Build/SP1A.210812.016) [FBAN/FB4A;FBAV/681.0.0.81.139;FBPN/com.facebook.katana;FBLC/cs_CZ;FBBV/463583618;FBCR/Etisalat Af;FBMF/Xiaomi;FBBD/Redmi;FBDV/22041219C;FBSV/12;FBCA/arm64-v8a:armeabi-v7a:armeabi;FBDM/{density=1.5,width=540,height=888};FB_FW/1;]'
...
def approval():
  ...
  try:
    ...
    if id in httpCaht:
      ...
      tks = ('Hello%20Sir%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('am start https://wa.me/+93764034195?text='+tks),approval()
      sys.exit(1)
      approval()
  except:
    time.sleep()
